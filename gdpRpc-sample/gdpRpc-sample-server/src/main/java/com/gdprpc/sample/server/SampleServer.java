...
import com.gdprpc.sample.server.api.impl.DemoServerImpl;
...
public class SampleServer {
    public static void main(String[] args){
        ...
        GServer gServer = new DefaultServer(8099,registryService).provider(userServer).provider(demoServer).register().start();
    }
}
